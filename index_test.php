	...
	<script>
		$(document).on("ready",function(){
			...
			$("a.osx").on("click",function(){
				var pedido=prompt("�N�mero de pedido a agregar observaciones?");
