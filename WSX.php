<?php
	...
	$IMEI="867530020454953";
	//$CODIGOFACTURA=$_POST['CF'];
	$CODIGOFACTURA="00000000000000109753";
	//$GUIA=trim($_POST['G']);
	$GUIA="Local";
	//$VALORGUIA=$_POST['VG'];
	$VALORGUIA="2279.4";
	...
	$FECHAENTREGA="16/06/2017 15:03:21";
	$Enviar = 0;
	...
	if($Enviar == 1){
		...
		if($reg=odbc_fetch_array($registros_email)){
			...
			else
			{
				...
				$mailCCO = "lesparza@fleximatic.com.mx;embarques@fleximatic.com.mx";
			}
