						...
						<div class='page'>
						 ...
						 while($datos=odbc_fetch_array($sql)){
                            ...
                            if($datos['B1_CAJCER']=='T')
							{
						 		...
						 		echo "<tr><td colspan='8'>Ubicaciones del producto: ".$datos["UBICAIONES"]."</td></tr>";
						 ...
						 odbc_free_result($sql);
						 echo "<tr><td colspan='7' style='text-align:right'>Total del pedido:</td><td  style='text-align:center'>$".number_format($valor,2)."</td></tr></table><strong>
