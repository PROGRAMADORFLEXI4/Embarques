   ...
   if ($num_ped <> "") {
        ...
        if (odbc_num_rows($rstGeneral) > 0) {
         ...
         // $res .= " CajaMultiple: ".($nMultipleMtrs3);
            ...
            $strconsultFiscal = "
            SELECT DDF_TDCLAS,DDF_COD,A2_NREDUZ,A2_TCOBRO,A2_FANOVAR, Z51_CODIGO,Z51_ESTADO,Z51_MNPIO,DDF_DIAS, DDF_COSTO, DDF_EAD as PORCENTEADFLE,DDF_BLOQFL, DDF_PORGAS,A2_PISTAS,A2_PORMANI,A2_COSTSER,A2_COSTOES,A2_TARIFAR FROM  DDF010 DDF 
            INNER JOIN  
                (SELECT Z51_CODIGO,Z51_ESTADO,Z51_MNPIO FROM Z51010 WHERE D_E_L_E_T_='' group by Z51_ESTADO,Z51_MNPIO,Z51_CODIGO) Z51
        ...
        if ($lExiste==true){
            ...
            <div class='container' style='width:1000; margin:0 auto;overflow:hidden; border-style:ridge;' >
                ...
                <h2>NO EXISTE INFORMACIÓN DEL PEDIDO</h2>
